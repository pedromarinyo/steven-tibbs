...
function questGenerator(tool, killer, crimescene) {
    ...
    switch (this.tool){
    	...
    	case "rope":
    	this.allQuests.push(new quest("object","find the rope",ll.ferst, 'none', 'found rope and personal belongings'));
		...
		this.allQuests.push(new quest("record","meet with security",ll.studentCenter, 'none', 'got witnesses about mailman visits'));
    	...
    	this.allQuests.push(new quest("personal","find the enemy",ll.library, 'none', 'meet with Tibbs friends to know tibbs fan who is a psychopass'));
    	this.allQuests.push(new quest("personal-investigate","Go to Tibbs desk to find data from phone ",ll.vanLeer, 'none', 'Suspect left a threatening text message '));
